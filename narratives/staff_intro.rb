...
Hey, can you post a Wikipedia link on #{ subject.to_s }? Try replying with a link on a line by itself, and it'll automatically expand to include a nifty summary.
}
...
# TODO Maybe move this to another file to declutter. Also gzip or something before posting. Sory 4 long line  
  state :end do | user |
    reply get_user, %Q{Wow, good job! I think after all that you deserve an award!\n\n
